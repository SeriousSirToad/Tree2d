...
public class EntityHandler {
	...
	public EntityHandler(Engine engine) {
		...
		this.engine = engine;
		p = new Player("Developer", 1 * Tile.width, 0 * Tile.width,
				engine.input, engine, engine.island);
		Utopia();
		Island_1();
	...
	public void Utopia() {
		...
		String johnText = "Hello "
				+ p.name
				+ " and welcome to Tree Town pre Alpha release \n "
		...
		String[] parque = {
				"I really love the park.",
				"Did you know I am the most recent addition \n"
						+ "to this map?", "You're very chatty." };
		NPC npc_1 = new Lumberjack(40 * Tile.width, 22 * Tile.width,
				"shit be working yo", "Ian", 1, engine, Island.Utopia);
		NPC npc_2 = new Lumberjack(54 * Tile.width, 32 * Tile.width, parque,
				"Park guy", 0, engine, Island.Utopia);
		NPC john = new Lumberjack(11 * Tile.width, 6 * Tile.width, johnText,
				"John", 0, engine, Island.Utopia);
